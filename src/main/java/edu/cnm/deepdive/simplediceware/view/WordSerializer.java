package edu.cnm.deepdive.simplediceware.view;
...
public class WordSerializer {
  ...
  public static class Deserializer extends JsonDeserializer<Word> { // takes Json and turns into Java

    @Override
    public Word deserialize(JsonParser jsonParser, DeserializationContext deserializationContext)
        throws IOException, JsonProcessingException {
      Word word = new Word();
      word.setText(jsonParser.readValueAs(String.class));
      return word;
    }
  }
}
